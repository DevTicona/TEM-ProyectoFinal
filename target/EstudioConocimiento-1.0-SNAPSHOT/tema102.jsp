...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Tecnicas avanzadas de collage </title>
    ...
    <body>
        ...
        <div class="content">
            <div class="cont">
                <h2><b>TEMA102: Tecnicas avanzadas de collage</b></h2>
                <iframe width="750" height="380" src="https://www.youtube.com/embed/7dWmIzQdBiI?si=R95FvGuvRimpMH7x" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <br><br>
